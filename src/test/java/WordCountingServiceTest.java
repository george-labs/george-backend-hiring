...
class WordCountingServiceTest {
    ...
    void when_text_contains_words_then_return_number_of_words() {
        ...
        var wordCount = wordCountingService.countWords(text, Collections.emptySet());
    ...
    void when_text_is_null_then_throw_exception() {
        String text = null;
        WordCountingService wordCountingService = new WordCountingService();
        Assertions.assertThrows(IllegalArgumentException.class, () -> wordCountingService.countWords(text, Collections.emptySet()));
    }
    ...
    void when_stop_words_are_in_text_then_do_not_count_them() {
        ...
        WordCountingService wordCountingService = new WordCountingService();
        var wordCount = wordCountingService.countWords(text, stopWords);
    ...
    void when_stop_words_are_empty_then_no_exception_is_thrown() {
        ...
        WordCountingService wordCountingService = new WordCountingService();
        Assertions.assertDoesNotThrow(() -> wordCountingService.countWords(text, stopWords));
    }
    ...
    void when_stop_words_are_null_then_exception_is_thrown() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> wordCountingService.countWords(text, null));
    }
